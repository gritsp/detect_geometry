...
class Colors:
    def __init__(self,frame):
        ...
        self.blackMinRange = (80,30,20)
        self.blackMaxRange = (110,120,80)
        self.whiteMinRange = (100,0,210)
        self.whiteMaxRange = (110,70,255)
        self.grayMinRange = (80,30,120)
        self.grayMaxRange = (120,75,170)
        self.brownMinRange = (0,0,95)
        self.brownMaxRange = (180,70,130)
        self.redMinRange = (160,90,130)
        self.redMaxRange = (180,125,255)
    ...
    def findGeometry(self):
        ...
        for contour in contours:
            ...
            cv2.drawContours(self.frame, [approx], 0, (0, 0, 0), 3)
            x = approx.ravel()[0]
            y = approx.ravel()[1] - 5
            M = cv2.moments(contour)
            cX = int(M["m10"] / (M["m00"]+1))
            cY = int(M["m01"] / (M["m00"]+1))
            color = str(self.isColor(self.hsv[cY,cX]))
